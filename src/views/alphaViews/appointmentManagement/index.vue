<template>
  <div class="app-container">
    <div style="background-color: white;padding: 20px">
      ...
      <!--            &lt;!&ndash;          <template slot-scope="scope">&ndash;&gt;-->
      <!--            &lt;!&ndash;            <el-select v-model="scope.row.userrole" placeholder="权限" @change="eidtAuthority(scope.row.userid, scope.row.userrole)">&ndash;&gt;-->
      <!--            &lt;!&ndash;              <el-option label="教师" value="教师"/>&ndash;&gt;-->
      <!--            &lt;!&ndash;              <el-option label="审核员" value="审核员"/>&ndash;&gt;-->
      <!--            &lt;!&ndash;              <el-option label="系统管理员" value="系统管理员"/>&ndash;&gt;-->
